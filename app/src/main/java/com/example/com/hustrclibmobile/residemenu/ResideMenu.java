package com.example.com.hustrclibmobile.residemenu;
...
public class ResideMenu extends FrameLayout implements GestureDetector.OnGestureListener{
	...
	//private static boolean isOnclickOpen;
    ...
    private void initValue(Activity activity){
      ...
      /*  view_activity.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if (isOpened && isOnclickOpen == false) {
					isOnclickOpen = true;
					closeMenu();
				}
			}
